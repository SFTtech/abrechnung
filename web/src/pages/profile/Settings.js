...
export default function Settings() {
    ...
    return (
        <Paper elevation={1} className={classes.paper}>
            ...
            <Alert style={{marginTop: 10}} severity="info">These settings are locally on your device. Clearing your Browser's local storage will reset them.</Alert>
            ...
            <div style={{marginTop: 20}}>
                <FormControl component="fieldset" variant="standard">
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={
                                <Switch checked={tSettings.showRemaining} onChange={handleTransactionShowRemainingChange} name="showRemaining"/>
                            }
