...
insert into tmp_currency_mapping (identifier, symbol)
values
    ('AED', 'د.إ;'),
    ('AFN', 'Afs'),
    ('ALL', 'L'),
...
update grp set currency_identifier = get_currency_identifier_for_symbol(currency_symbol);
alter table grp drop column currency_symbol;

alter table transaction_history add column currency_identifier text;
update transaction_history set currency_identifier = get_currency_identifier_for_symbol(currency_symbol);
