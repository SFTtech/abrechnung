    ...
    get:
        ...
        async ({ get }) => {
            ...
            for (const position of positions) {
                ...
                const totalUsages =
                    position.communist_shares + Object.values(position.usages).reduce((acc, curr) => acc + curr, 0);
                ...
                transactionValueAfterPositions[position.transaction_id] =
                    transactionValueAfterPositions[position.transaction_id] - position.price + commonRemainder;
            }
